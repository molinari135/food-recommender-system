...
PROJECT_NAME = food-recommender-system
PYTHON_VERSION = 3.12
...
.PHONY: lint
lint:
	flake8 food_recommender_system
	isort --check --diff --profile black food_recommender_system
	black --check --config pyproject.toml food_recommender_system
